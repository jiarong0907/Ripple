...
const bit<32> PULSEWAVES_SIZE = 65535;
...
control MyIngress(inout headers hdr,
    ...
    register <bit<32>>(65536) pulsewaves;
    ...
    register <bit<32>>(65536) reduce_pktlen_to_flowsz_s0_w3;
    ...
    register <bit<32>>(65536) reduce_pktlen_to_flowsz_s1_w3;
    ...
    register <bit<32>>(65536) reduce_pktlen_to_flowsz_s2_w3;
...
*************************************************************************/
		...
		if (meta.classification_filter1 == 1) {
            ...
            reduce_pktlen_to_flowsz_update.apply(hdr, meta, standard_metadata, \
                                ...
                                reduce_pktlen_to_flowsz_s0_w3, reduce_pktlen_to_flowsz_s1_w3, reduce_pktlen_to_flowsz_s2_w3);
		...
		if (meta.classification_filter1 == 1) {
                zip_flowsz_flowsz.apply(hdr, meta, standard_metadata, \
                                reduce_pktlen_to_flowsz_full_wind, \
                                reduce_pktlen_to_flowsz_s0_w0, reduce_pktlen_to_flowsz_s1_w0, reduce_pktlen_to_flowsz_s2_w0, \
                                reduce_pktlen_to_flowsz_s0_w1, reduce_pktlen_to_flowsz_s1_w1, reduce_pktlen_to_flowsz_s2_w1, \
                                reduce_pktlen_to_flowsz_s0_w2, reduce_pktlen_to_flowsz_s1_w2, reduce_pktlen_to_flowsz_s2_w2, \
		...
		if (meta.classification_filter1 == 1) {
                filter_flowsz1_flowsz2_classification1_3.apply(hdr, meta, standard_metadata, \
                            reduce_pktlen_to_flowsz_cur_wind_pass);

                if (meta.classification_filter1 == 1){
                    filter_flowsz1_flowsz2_return.apply(hdr, meta, standard_metadata, \
                                pulsewaves);
                }
	 	}
...
*******************************************************************************/
		...
		if (meta.mitigation_filter1 == 1) {
                filter_sip_in_pulsewaves_mitigation1.apply(hdr, meta, standard_metadata, \
                            pulsewaves);
