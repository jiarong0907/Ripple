...
control filter_flowsz_return(inout headers hdr,
    ...
    apply{
        ...
        {NUM_RAND1, meta.sip, meta.dip, meta.sport, meta.dport, NUM_RAND2}, (bit<16>)SUSPICIOUS_SIZE);
        hash(suspicious_idx1, HashAlgorithm.crc16, (bit<32>)0,
        {NUM_RAND1, NUM_RAND2, meta.sip, meta.dip, meta.sport, meta.dport}, (bit<16>)SUSPICIOUS_SIZE);
        hash(suspicious_idx2, HashAlgorithm.crc16, (bit<32>)0,
        {meta.sip, meta.dip, meta.sport, meta.dport, NUM_RAND1, NUM_RAND2}, (bit<16>)SUSPICIOUS_SIZE);
...
control filter_sip_dip_sport_dport_in_suspicious_mitigation1(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata,
                  in register<bit<32>> suspicious) {
