...
control filter_reroute_classification1_2(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata) {
...
control filter_reroute_classification3_4(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata) {
    ...
    apply{
        if (meta.reroute == 1) {
            ...
            meta.classification_filter4 = 0; //no high load, clean this flag
        }
    }
}
...
control filter_link_in_victimLks_classification5(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata,
                  in register<bit<32>> victimLks) {
...
control filter_victimLks_size_classification5_8(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata,
                  in register<bit<32>> victimLks_size) {
...
control filter_victimLks_size_classification7_11(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata,
                  in register<bit<32>> victimLks_size) {
...
control filter_reroute_classification7_12(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata) {
...
control filter_flowsz2_flowsz1_classification7_14(inout headers hdr,
                  inout metadata meta,
                  inout standard_metadata_t standard_metadata,
                  in register<bit<32>> reduce_pktlen_to_flowsz2_cur_wind_pass,
                  in register<bit<32>> reduce_pktlen_to_flowsz1_cur_wind_pass) {
    ...
    apply{
        ...
        if (meta.flowsz2_val - meta.flowsz1_val < 3000 && meta.flowsz2_val > meta.flowsz1_val && reduce_pktlen_to_flowsz2_cur_wind_pass_val >= 1 && reduce_pktlen_to_flowsz1_cur_wind_pass_val >= 1) {
            meta.classification_filter7 = 1;
        } else {
            meta.classification_filter7 = 0; //no high load, clean this flag
        }
